...
__decorate([
    (0, mongoose_1.Prop)({ ref: "Courses", type: [mongoose_2.default.Schema.Types.ObjectId] }),
    __metadata("design:type", Array)
], Users.prototype, "courses_enrolled", void 0);
__decorate([
    (0, mongoose_1.Prop)({ ref: "Courses", type: [mongoose_2.default.Schema.Types.ObjectId] }),
    __metadata("design:type", Array)
], Users.prototype, "courses_created", void 0);
Users = __decorate([
    (0, mongoose_1.Schema)({
        timestamps: true
    })
